            ...
            <div className="container mx-auto p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <Card className="border shadow-sm p-4">
                  <div className="mb-2">
                    <h2 className="text-base font-medium">Dự án và phần trăm tiến độ dự án </h2>
                ...
                <Card className="border shadow-sm p-4">
                  <div className="mb-2">
                    <h2 className="text-base font-medium">Biểu đồ thống kê dự án</h2>
                  </div>
                  <div className="text-center mt-2">
                    <div className="text-3xl font-bold">{dashboardData.length}</div>
                    <div className="text-xs text-gray-500">Tổng Số Dự Án</div>
                  </div>
                  <div className="h-[180px] mt-2">
                    <PieChart data={dashboardData.map(item => ({
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs mt-2">
                    <div className="flex items-center justify-center">
                      ...
                      <span>Hoàn thành: {dashboardData.filter(d => d.status === 'DONE').length}</span>
                    </div>
                    <div className="flex items-center justify-center">
                      <div className="w-3 h-3 rounded-full bg-orange-500 mr-1"></div>
                      <span>Đang tiến hành: {dashboardData.filter(d => d.status === 'IN_PROGRESS').length}</span>
                    </div>
                  </div>
                </Card>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <Card className="border shadow-sm p-4 mt-4">
                  <h2 className="text-base font-medium mb-2">6 hoạt động gần nhất</h2>
              ...
              <Card className="border-white shadow-sm p-4 mb-4">
                ...
                <div className="overflow-x-auto">
                  <table className=" min-w-full rounded-xl text-center">
                    <thead>
                      <tr className="">
                        <th scope="col" className="p-5 text-sm leading-6 font-semibold capitalize border border-white"> Company </th>
                        <th scope="col" className="p-5 text-sm leading-6 font-semibold capitalize border border-white"> User ID </th>
                        <th scope="col" className="p-5 text-sm leading-6 font-semibold capitalize border border-white"> Type </th>
                        <th scope="col" className="p-5 text-sm leading-6 font-semibold capitalize border border-white"> Industry Type </th>
                        <th scope="col" className="p-5 text-sm leading-6 font-semibold capitalize border border-white"> Actions </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-300 ">

                      {[...Array(5)].map((_, index) => (
                        <tr key={index} className=" transition-all duration-500 ">
                          <td className=" border border-white p-5 whitespace-nowrap text-sm leading-6 font-medium "> Louis Vuitton</td>
                          <td className=" border border-white p-5 whitespace-nowrap text-sm leading-6 font-medium"> 20010510 </td>
                          <td className=" border border-white p-5 whitespace-nowrap text-sm leading-6 font-medium"> Customer</td>
                          <td className=" border border-white p-5 whitespace-nowrap text-sm leading-6 font-medium"> Accessories</td>
