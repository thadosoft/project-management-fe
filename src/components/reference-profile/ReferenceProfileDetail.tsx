...
import { getById } from "@/services/reference-profile/moduleService";
        ...
        <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
            <SidebarProvider>
                ...
                <SidebarInset>
                    ...
                    <div className="p-4">
                        <h1 className="font-bold text-2xl">Thư mục tham khảo phân hệ: {profile?.title}</h1>
                        <div className="w-2/5 mx-auto my-5 py-12 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed">
