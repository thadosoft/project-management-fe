...
function DashboardTechnical() {
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      setLoading(true);
      await Promise.all([fetchDashboard(), fetchLogs(), fetchLateStaff(), fetchProjects()]);
      setLoading(false);
    };
                ...
                >
                  <Card>
                    ...
                    <CardFooter className="flex justify-center">
                      {newProjectName !== "" && !projects.some(p => p.name.toLowerCase() === newProjectName.toLowerCase()) ? (
                        <div className="pt-4">
                          <Button onClick={handleCreateProject}>Create</Button>
                        </div>
                      ) : (
                        <div className="pt-4">
                          <Button className="opacity-50 hover:bg-white cursor-auto">Create</Button>
                        </div>
                      )}
                    </CardFooter>
                  </Card>
